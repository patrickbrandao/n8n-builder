...
# Biblioteca de funcoes shell script
    ...
    _echo_cmd(){ printf "   \033[34;7m > \033[33;6m $1 \033[0m\n"; };
    _echo_replace(){
    ...
    _eval(){
        ...
        # falhou:
        echo;
        _echo_fatal "Erro $stdno ao executar:";
        _echo_fatal "   Diretorio corrente: $HERE";
        _echo_fatal "   Comando...........: $1";
        _echo_fatal "   Codigo do erro....: $stdno";
        echo;
        exit $stdno;
    };
